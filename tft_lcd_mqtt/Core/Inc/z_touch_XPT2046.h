 ...
 **********************************************************************************/
#ifdef ILI9341
#define X_THRESHOLD		0x0200	//below threshold there is no touch
#define Z_THRESHOLD		0x0200	//below threshold there is no touch
#endif
#ifdef ILI9488
#define X_THRESHOLD		0x0500	//below threshold there is no touch
#define Z_THRESHOLD		0x0500	//below threshold there is no touch
#endif
